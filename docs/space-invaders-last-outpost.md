...
- **Batteria laser** *(rara, unica)*: si carica in 500 ms solo quando il giocatore e vicino al suo slot, poi colpisce automaticamente il nemico bersagliabile con piu integrita. Il raggio attraversa tutti i nemici lungo la linea e infligge un danno base a ciascuno. Una barra sulla struttura mostra la carica e si illumina quando il giocatore e nel raggio d'azione. I suoi potenziamenti recuperano carica dopo un colpo multiplo, scelgono la linea con piu bersagli fra i nemici a pari integrita e ampliano la zona di carica.
- **Mortaio** *(unico)*: si carica in 1,8 secondi quando il giocatore e entro 80 px. Spara al nemico bersagliabile con piu integrita; dopo 400 ms il colpo esplode nella posizione presa di mira, infliggendo 3 danni al bersaglio se e ancora nell'area e meta del danno diretto, arrotondata per difetto, agli altri nemici entro 80 px. Schegge amplia il raggio a 100 px, Proiettile pesante porta il danno diretto a 5 e il danno ad area a 2, e Calcolo balistico sceglie, fra i bersagli piu resistenti, l'area che colpisce piu nemici.
